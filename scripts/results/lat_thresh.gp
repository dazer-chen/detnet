...
set y2label "Priority-Flow Loss-Percentage (%)"
...
plot \
'<cat bwresv_thvar_4500_latency.dat'	u ($2):($4) t 'Av-Latency' axes x1y1 with lp lc rgb "blue" lw 2 pt ft,\
'<cat bwresv_thvar_4500_flow_3.dat'		u ($2):($12)*100 t 'Loss %' axes x1y2 with lp lc rgb "red" lw 2 pt fc,\
#'<cat delay_util_profile_bwresv_10.dat'	u  ($3)/1000:($4) t 'Th=10' axes x1y1 with lp lc rgb "black" pt ec,\
#'<cat delay_util_profile_bwresv_160.dat'	u ($3)/1000:($4) t 'Th=160' axes x1y1 with lp lc rgb "violet" pt ei,\
#'<cat delay_util_profile_bwresv_640.dat'	u ($3)/1000:($4) t 'Th=640' axes x1y1 with lp lc rgb "green" pt es,\
#'<cat delay_util_profile_bwresv_80.dat'	u ($3)/1000:($4) t '80' axes x1y1 with lp lc rgb "black",\
#'<cat delay_util_profile_bwresv_160.dat'	u ($3)/1000:($4) t '160' axes x1y1 with lp lc rgb "dark-blue",\
#'<cat delay_util_profile_bwresv_320.dat'	u ($3)/1000:($4) t '320' axes x1y1 with lp lc rgb "dark-red",\
#'<cat delay_util_profile_fifo.dat'	u ($2)/1000:($3) t 'FIFO' axes x1y1 with lp lc rgb "green"
