...
set xlabel "Bitrate of Each Priority Flow (Mbps)"
set xtics 1
...
set ylabel "Bitrate of Non-Priority Flow (Mbps)"
...
#set arrow 2 from 4.5,3 to 4.5,3.5
#set label "Bw Reservation\nPer Detnet flow" at 4,4



plot \
'<cat rx_bwresv_flow_1.dat'	u ($2)/1000:($6)/1000 t 'Rx Bwresv' axes x1y1 with linespoints lw 1.5 pt ft lc rgb "blue",\
'<cat rx_stresv_flow_1.dat'	u ($2)/1000:($6)/1000 t 'Rx STRESV' axes x1y1 with linespoints lw 1.5 pt ec lc rgb "black",\
'<cat tx_bwresv_flow_1.dat'	u ($2)/1000:($6)/1000 t 'Tx' axes x1y1 with linespoints lw 1.5 pt et lc rgb "red",\
'<cat rx_fd_flow_1.dat'		u ($2)/1000:($6)/1000 t 'Rx FD' axes x1y1 with linespoints lw 1 pt es lc rgb "green",\
'<cat rx_ared_flow_1.dat'	u ($2)/1000:($6)/1000 t 'Rx ARED' axes x1y1 with linespoints lw 1.5 pt ed lc rgb "violet"
'<cat rx_fifo_flow_1.dat'	u ($2)/1000:($6)/1000 t 'Rx FIFO' axes x1y1 with linespoints lw 1.5 pt ed lc rgb "violet"
