...
#set out "jitter_detnet.pdf"
set out "jitter_fifo.pdf"
...
plot \
'< cat delay.dat | tail -n 13'    u ($0):($5)      t 'Latency Other-1'    axes x1y1 with steps lc rgb "green" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($17)      t 'Latency Other-2'    axes x1y1 with steps lc rgb "orange" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($11)      t 'Latency Detnet-1'   axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($23)     t 'Latency Detnet-2'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($29)     t 'Latency Detnet-3'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($35)     t 'Latency Detnet-4'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($41)     t 'Latency Detnet-5'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($47)     t 'Latency Detnet-6'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($53)     t 'Latency Detnet-7'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($59)     t 'Latency Detnet-8'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($65)     t 'Latency Detnet-9'  axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($71)     t 'Latency Detnet-10' axes x1y1 with steps lc rgb "black" lw 2,\
'< cat delay.dat | tail -n 13'    u ($0):($77)     t 'Total Mean Latency' axes x1y1 with steps lc rgb "red" lw 2
#pause 0.5
#reread
