...
plot \
'<cat rx_bwresv_1_flow_3.dat'	u ($3)/1000:($7)/1000 t 'Th=1' axes x1y1 with linespoints lw 1 pt ft lc rgb "blue" pointsize 1,\
'<cat rx_bwresv_10_flow_3.dat'	u ($3)/1000:($7)/1000 t 'Th=10' axes x1y1 with linespoints lw 1 pt ec lc rgb "black" pointsize 1,\
'<cat rx_bwresv_160_flow_3.dat'	u ($3)/1000:($7)/1000 t 'Th=160' axes x1y1 with linespoints lw 1.5 pt ei lc rgb "violet",\
'<cat rx_bwresv_640_flow_3.dat'	u ($3)/1000:($7)/1000 t 'Th=640' axes x1y1 with linespoints lw 1 pt es lc rgb "green",\
'<cat tx_bwresv_640_flow_3.dat'	u ($3)/1000:($7)/1000 t 'Tx' axes x1y1 with linespoints lw 1 pt et lc rgb "red",\
#'<cat rx_bwresv_80_flow_3.dat'	u ($3)/1000:($7)/1000 t '80' axes x1y1 with linespoints lw 1 pt ed lc rgb "violet",\
#'<cat rx_bwresv_160_flow_3.dat'	u ($3)/1000:($7)/1000 t '160' axes x1y1 with linespoints lw 1 pt ed lc rgb "dark-blue"
...
plot \
'<cat rx_bwresv_1_flow_1.dat'	u ($3)/1000:($7)/1000 t '1' axes x1y1 with linespoints lw 1 pt ft lc rgb "blue" pointsize 1,\
'<cat rx_bwresv_10_flow_1.dat'	u ($3)/1000:($7)/1000 t '10' axes x1y1 with linespoints lw 1 pt ec lc rgb "black" pointsize 1,\
'<cat rx_bwresv_160_flow_1.dat'	u ($3)/1000:($7)/1000 t '160' axes x1y1 with linespoints lw 1.5 pt ei lc rgb "violet",\
'<cat rx_bwresv_640_flow_1.dat'	u ($3)/1000:($7)/1000 t '640' axes x1y1 with linespoints lw 1 pt es lc rgb "green",\
'<cat tx_bwresv_640_flow_1.dat'	u ($3)/1000:($7)/1000 t 'Tx' axes x1y1 with linespoints lw 1 pt et lc rgb "red",\
#'<cat rx_bwresv_80_flow_1.dat'	u ($3)/1000:($7)/1000 t '80' axes x1y1 with linespoints lw 1 pt ed lc rgb "violet",\
#<cat rx_bwresv_160_flow_1.dat'	u ($3)/1000:($7)/1000 t '160' axes x1y1 with linespoints lw 1 pt ed lc rgb "dark-blue"
