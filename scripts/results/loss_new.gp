...
plot \
'<cat rx_bwresv_flow_3.dat'	u ($2)/1000:($11)*100 t 'MFD' axes x1y1 with linespoints lw 2.5 pt ft lc rgb "blue",\
'<cat rx_stresv_flow_3.dat'	u ($2)/1000:($11)*100 t 'STRESV' axes x1y1 with linespoints lw 1 pt ec lc rgb "black",\
'<cat rx_fd_flow_3.dat'		u ($2)/1000:($11)*100 t 'FD' axes x1y1 with linespoints lw 1 pt es lc rgb "green",\
'<cat rx_ared_flow_3.dat'	u ($2)/1000:($11)*100 t 'ARED' axes x1y1 with linespoints lw 1 pt ei lc rgb "brown",\
'<cat rx_fifo_flow_3.dat'	u ($2)/1000:($11)*100 t 'FIFO' axes x1y1 with linespoints lw 1 pt ed lc rgb "violet"
...
plot \
'<cat rx_bwresv_flow_1.dat'	u ($2)/1000:($11)*100 t 'loss MFD' axes x1y1 with linespoints lw 1.5 pt ft lc rgb "blue",\
'<cat rx_stresv_flow_1.dat'	u ($2)/1000:($11)*100 t 'loss STRESV' axes x1y1 with linespoints lw 1 pt ec lc rgb "black",\
'<cat rx_fd_flow_1.dat'		u ($2)/1000:($11)*100 t 'loss FD' axes x1y1 with linespoints lw 1 pt es lc rgb "green",\
'<cat rx_ared_flow_3.dat'	u ($2)/1000:($11)*100 t 'loss ARED' axes x1y1 with linespoints lw 1 pt ei lc rgb "brown",\
