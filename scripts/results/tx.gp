...
plot \
'< cat tx.dat'    u ($0):($2)/1000      t 'Tx Other-1'  axes x1y1 with steps,\
'< cat tx.dat'    u ($0):($5)/1000      t 'Tx Other-2'  axes x1y1 with  steps,\
'< cat tx.dat'    u ($0):($8)/1000      t 'Tx Detnet-1'  axes x1y1 with  steps,\
'< cat tx.dat'    u ($0):($11)/1000      t 'Tx Detnet-2'  axes x1y1 with steps,\
'< cat tx.dat'    u ($0):($14)/1000      t 'Tx Detnet-3'  axes x1y1 with steps ,\
'< cat tx.dat'    u ($0):($17)/1000      t 'Tx Detnet-4'  axes x1y1 with steps ,\
'< cat tx.dat'    u ($0):($20)/1000      t 'Tx Detnet-5'  axes x1y1 with steps ,\
'< cat tx.dat'    u ($0):($23)/1000      t 'Tx Detnet-6'  axes x1y1 with steps ,\
'< cat tx.dat'    u ($0):($26)/1000      t 'Tx Detnet-7'  axes x1y1 with steps ,\
'< cat tx.dat'    u ($0):($29)/1000      t 'Tx Detnet-8'  axes x1y1 with steps ,\
'< cat tx.dat'    u ($0):($32)/1000      t 'Tx Detnet-9'  axes x1y1 with steps,\
'< cat tx.dat'    u ($0):($35)/1000      t 'Tx Detnet-10'  axes x1y1 with steps lc rgb "red",\
'< cat tx.dat'    u ($0):($38)/1000      t 'Tx Total'  axes x1y1 with steps lc rgb "black" 
